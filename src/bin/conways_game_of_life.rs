//! Conway's Game of Life Demo - Haggis Engine Showcase
//!
//! This is a standalone binary that demonstrates the Haggis 3D rendering and 
//! simulation engine with Conway's Game of Life running on GPU compute shaders.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("🔬 Haggis Engine - Conway's Game of Life Demo");
    println!("==============================================");
    println!("GPU-accelerated cellular automaton with real-time 3D visualization");
    println!();
    println!("Features:");
    println!("  • High-performance GPU compute shaders");
    println!("  • Real-time 3D visualization (256x256 grid)");
    println!("  • Interactive pattern selection and speed control");
    println!("  • Ping-pong buffer optimization");
    println!();
